// =============================================================================
// VENDORIZADO — copia de `packages/shared/src/contracts/auth.ts` (monorepo VoyYa /
// repo `frontend-yavoy`). `frontend-yavoy-admin` es un repo standalone SIN workspace
// pnpm compartido, así que este archivo se vendoriza tal cual en vez de depender de
// `@voyya/shared` — evita reinventar a mano los DTOs/Zod schemas de auth (DRY dentro
// de lo posible dado el aislamiento del repo). MANTENER EN SYNC manualmente con el
// origen (y con `backend-yavoy`) — ver README § Nota de sincronización de contratos.
// NO editar campos/reglas aquí sin replicar el cambio en el origen.
// =============================================================================
// =============================================================================
